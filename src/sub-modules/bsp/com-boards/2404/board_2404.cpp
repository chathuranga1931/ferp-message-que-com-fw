...
#include "board.h"
#include "board_2404_wrap.h"

#define __TAG__  "BRD_2404"
...
void board_led1_on()
{
    pal_gpio_write(ESP_LED1, true);
}

void board_led1_off()
{
    pal_gpio_write(ESP_LED1, false);
}

void board_led2_on()
{
    pal_gpio_write(ESP_LED2, true);
}

void board_led2_off()
{
    pal_gpio_write(ESP_LED2, false);
}
