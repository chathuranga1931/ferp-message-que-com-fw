...
*
*/
static void get_display_data(display_data_t *dd, tu_word_t *ab)
{
	display_data_t data = {};
...
esp_err_t display_censtar_7_digit_init(QueueHandle_t *send_que)
{
	...
	ESP_LOGI(TAG, "Staring Censtar 7 display\r\n");
end:
	return ret;
}