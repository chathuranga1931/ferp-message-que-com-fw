...
const char* esp_loader_get_target_str(target_chip_t id)
{
    const char *chip_name[] = {"ESP8266", "ESP32", "ESP32S2", "ESP32C3", "ESP32S3", "ESP32C2", "ESP32_RESERVE", "ESP32H2", "ESP32C6"};

    return id < ESP_MAX_CHIP ? chip_name[id] : "ESP_UNKNOWN";
}
