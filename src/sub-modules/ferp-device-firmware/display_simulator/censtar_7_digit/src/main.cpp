...
data_t sdata1_tx[PACKET_SIZE] = {
    {{.INDX = 0x05, .DIGI = 0}},   // Price IDX 0
    {{.INDX = 0x15, .DIGI = 0}},   // Price IDX 1
    {{.INDX = 0x25, .DIGI = 6}},   // Price IDX 2
    {{.INDX = 0x35, .DIGI = 5}},   // Price IDX 3
    {{.INDX = 0x45, .DIGI = 3}},   // Price IDX 4
    {{.INDX = 0x55, .DIGI = 3}},   // Total IDX 0
    {{.INDX = 0x65, .DIGI = 8}},   // Total IDX 1
    {{.INDX = 0x75, .DIGI = 0}},   // Total IDX 2
    {{.INDX = 0x85, .DIGI = 6}},   // Total IDX 3
    {{.INDX = 0x95, .DIGI = 8}},   // Total IDX 4
    {{.INDX = 0xA5, .DIGI = 5}},   // Total IDX 5
    {{.INDX = 0xB5, .DIGI = 0xF}}, // Total IDX 6
    {{.INDX = 0xC5, .DIGI = 3}},   // Volume IDX 0
    {{.INDX = 0xD5, .DIGI = 6}},   // Volume IDX 1
    {{.INDX = 0xE5, .DIGI = 4}},   // Volume IDX 2
    {{.INDX = 0xF3, .DIGI = 6}},   // Volume IDX 3
    {{.INDX = 0xF0, .DIGI = 1}},   // Volume IDX 4
    {{.INDX = 0xF1, .DIGI = 0xF}}, // Volume IDX 5
    {{.INDX = 0xF2, .DIGI = 0xF}}, // Volume IDX 6
};
...
const float unit_price = 423.21; // 0.01
...
void create_buffer_censtar_7(float volume, float price)
{
    ...
    for (size_t i = IDX_UNIT_0; i < IDX_UNIT_SIZE; i++)
    {
        ...
        {
            sdata1_tx[i].DIGI = DIS_CHARACTOR_BLANK; // blank for the rest
        }
    }
...
void create_buffer_censtar_7_ll(uint64_t total_ll, float price)
{
    ...
    sdata1_tx[LL_IDX_LL_1].DIGI = DIS_CHARACTOR_L;
    sdata1_tx[LL_IDX_LL_2].DIGI = DIS_CHARACTOR_L;
