...
typedef struct {
    ...
    void (*reset_trg_fn)(bool level); /*!< This function pointer will be used to reset target chip */
    void (*gpio0_trg_fn)(bool level); /*!< This function pointer will be used to toggle set IO0 of target chip */
