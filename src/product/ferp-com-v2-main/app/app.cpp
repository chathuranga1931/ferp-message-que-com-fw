...
static ota_esp32_dt_ctx_t s_esp07_dt_boot_ctx = { .spiffs_path = "esp07/bootloader.bin", .is_open = false };
static ota_esp32_dt_ctx_t s_esp07_dt_part_ctx = { .spiffs_path = "esp07/partitions_table.bin", .is_open = false };
static ota_esp32_dt_ctx_t s_esp07_dt_fw_ctx   = { .spiffs_path = "esp07/rtos_dis_tap_esp07.bin",   .is_open = false };
...
static const ota_target_desc_t k_ota_targets[] = {
    ...
    { OTA_TARGET_DT_BOOT_IDX,   false, {}, "esp07-dt-boot", &g_ota_driver_esp07_dt,   &s_esp07_dt_boot_ctx },
    { OTA_TARGET_DT_PART_IDX,   false, {}, "esp07-dt-part", &g_ota_driver_esp07_dt,   &s_esp07_dt_part_ctx },
    { OTA_TARGET_DT_FW_IDX,     false, {}, "esp07-dt-fw",   &g_ota_driver_esp07_dt,   &s_esp07_dt_fw_ctx   },
};
...
extern "C" void app_init(void)
{
    ...
    LOG_MSG_DEBUG(true, "Setting CubeSphere root CA:\n%s", global_root_ca);
    ModuleCubeSphere::instance()->set_root_ca((char *)global_root_ca);
