...
hsys_msg_t *MsgTimerStartResponse::from_json(const char *payload_json, hsys_module_id_t sender_id)
{
    JsonDocument doc;
...
int32_t MsgTimerStartResponse::to_json(const hsys_msg_t *msg, char *data_json, uint32_t buf_len)
{
