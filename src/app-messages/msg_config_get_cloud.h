// msg_config_get_cloud.h
//
// Typed message class for MSG_ID_CONFIG_GET_CLOUD.
//
// Broadcast NOTIFICATION after MsgConfigReady.  ModuleConfig responds
// DIRECT with MsgConfigCloud to p.source_module_id.

#ifndef MSG_CONFIG_GET_CLOUD_H
#define MSG_CONFIG_GET_CLOUD_H

#include "IHsysMsg.h"
#include "hsys_msg.h"
#include "app_msg_ids.h"

class MsgConfigGetCloud : public IHsysMsg
{
public:
    static constexpr hsys_msg_id_t ID = MSG_ID_CONFIG_GET_CLOUD;
    ...
    explicit MsgConfigGetCloud(const Payload &payload) : m_payload(payload) {}
