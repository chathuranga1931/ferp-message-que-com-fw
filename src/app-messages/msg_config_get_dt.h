// msg_config_get_dt.h
//
// Typed message class for MSG_ID_CONFIG_GET_DT.
//
// DT = Device Type / hardware configuration.
// Broadcast NOTIFICATION after MsgConfigReady.  ModuleConfig responds
// DIRECT with MsgConfigDT to p.source_module_id.

#ifndef MSG_CONFIG_GET_DT_H
#define MSG_CONFIG_GET_DT_H

#include "IHsysMsg.h"
#include "hsys_msg.h"
#include "app_msg_ids.h"

class MsgConfigGetDT : public IHsysMsg
{
public:
    static constexpr hsys_msg_id_t ID = MSG_ID_CONFIG_GET_DT;
    ...
    explicit MsgConfigGetDT(const Payload &payload) : m_payload(payload) {}
