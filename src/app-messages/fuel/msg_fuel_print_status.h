...
//   auto *msg = create_typed<MsgFuelPrintStatus>(p);
//   publish(msg);
//
// Subscriber (ModuleCubeSphere):
//
//   case MsgFuelPrintStatus::ID: {
...
class MsgFuelPrintStatus : public IHsysMsg
{
public:
    ...
    explicit MsgFuelPrintStatus(const Payload &p) : _p(p) {}
