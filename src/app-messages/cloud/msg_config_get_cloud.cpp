...
hsys_msg_t *MsgConfigGetCloud::from_json(const char * /*data_json*/, hsys_module_id_t sender_id)
{
    Payload p{};
...
int32_t MsgConfigGetCloud::to_json(const hsys_msg_t *msg, char *data_json_out, uint32_t buf_len)
{
