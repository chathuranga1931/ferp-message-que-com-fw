...
#define HSYS_MAX_DATA_SIZE 1024
#define HSYS_OTA_BUFFER_SIZE 512
#define HSYS_MIN_FRAME_SIZE 22  // Minimum frame size without data
...
typedef struct {
    ...
    uint8_t* data;              // DATA - variable (up to 1K)
